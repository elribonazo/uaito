...
import { ToolResultBlock, ToolStartBlock, ToolUseBlock } from '@uaito/sdk';
  ...
  return <div className="w-full p-2 mt-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-xs">
     ...
     <button 
      ...
      >
        ...
        {
          typeof props.content !== "string" && props.content.map((content, i) => {
...
export const ToolComponent: React.FC<( ToolStartBlock | ToolUseBlock  | ToolResultBlock ) & {name: string, messageId: string}>  = (props) => {
